...
+function ($) {
    ...
    var Selector = {
        ...
        sidebarHead: '.sidebar-header',
        sidebarCont: '.sidebar-content',
        sidebarFoot: '.sidebar-footer',
    ...
    Layout.prototype.fix = function () {
        ...
        var sidebarHeader = $(Selector.sidebarHead).height() || 0;
        var sidebarFooter = $(Selector.sidebarFoot).height() || 0;
        console.log(windowHeight);
        console.log($(Selector.sidebar));
        $(Selector.sidebar).css('height', windowHeight);
        $(Selector.sidebarCont).slimScroll({
            height: windowHeight - sidebarHeader - sidebarFooter
        });
